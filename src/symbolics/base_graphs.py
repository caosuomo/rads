...
class Symbol_Graph( nx.DiGraph ):
    ...
    def add_edge( self, u, v, orientation=None ):
        ...
        Wraps nx.DiGraph.add_edge()
        """
        self.graph.add_edge( u, v, weight=orientation )



class Index_Map( Symbol_Graph ):
    """
...
class Generators( Index_Map ):
    """
    A representation of each generator based on the regions in phase space.
    """
    def __init__( self, **args ):
        fargs = {'graph' : None}
        fargs.update( args )
