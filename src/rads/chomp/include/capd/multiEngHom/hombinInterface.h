...
fcout << "HombinInterface requested maxSize=" << maxSize  << std::endl;
  ...
  switch(logTwo){
    case 10:   chomp::homology::ComputeBettiNumbers<3,10,int>(buf, &betti[0]);break;
    case 9:    chomp::homology::ComputeBettiNumbers<3,9,int>(buf, &betti[0]);break;
    case 8:    chomp::homology::ComputeBettiNumbers<3,8,int>(buf, &betti[0]);break;
    case 7:    chomp::homology::ComputeBettiNumbers<3,7,int>(buf, &betti[0]);break;
    case 6:    chomp::homology::ComputeBettiNumbers<3,6,int>(buf, &betti[0]);break;
    case 5:    chomp::homology::ComputeBettiNumbers<3,5,int>(buf, &betti[0]);break;
