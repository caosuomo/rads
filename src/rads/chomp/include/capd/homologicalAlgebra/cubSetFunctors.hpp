...
using chomp::matrixAlgorithms::kernelImage;
using chomp::matrixAlgorithms::quotientBaseMatrix;

typedef FreeChainComplex<FreeModule<ElementaryCell,chomp::vectalg::Matrix<int,0,0> > > BasicElementaryCellFreeChainComplexType;
...
class CubSetFunctors{
  ...
  typedef FreeModule<int,chomp::vectalg::Matrix<ScalarType,0,0> > ZGenFreeModule;
  ...
  // Define the free module with generators of type int
//  typedef FreeModule<int,chomp::vectalg::Matrix<int,0,0> > ZGenFreeModule;
