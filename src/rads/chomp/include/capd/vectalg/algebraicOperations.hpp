...
ResultType addObjects(const T1& v1,const T2& v2)
{
  if(v1.dimension()!=v2.dimension())
    throw std::range_error("chomp::vectalg::addObjects: Incompatible dimensions");
...
T1& addAssignObjectObject(T1& u, const T2& v)
{
  if(u.dimension()!=v.dimension())
    throw std::range_error("chomp::vectalg::addAssignObjectObject: Incompatible dimensions");
...
{
  if(u.dimension()!=v.dimension())
    throw std::range_error("chomp::vectalg::subtractAssignObjectObject: Incompatible dimensions");
  typename T1::iterator i=u.begin();
  typename T2::const_iterator b=v.begin(), e=v.end();
  while(b!=e)
  {
...
{
  if(v1.dimension()!=v2.dimension())
    throw std::range_error("chomp::vectalg::lessThan: Incompatible dimensions");
...
{
  if(v1.dimension()!=v2.dimension())
    throw std::range_error("chomp::vectalg::greaterThan: Incompatible dimensions");
  typename T1::const_iterator b1=v1.begin(), e1=v1.end();
  typename T2::const_iterator b2=v2.begin();
...
{
  if(v1.dimension()!=v2.dimension())
    throw std::range_error("chomp::vectalg::lessEqual: Incompatible dimensions");
  typename T1::const_iterator b1=v1.begin(), e1=v1.end();
  typename T2::const_iterator b2=v2.begin();
...
{
  if(v1.dimension()!=v2.dimension())
    throw std::range_error("chomp::vectalg::greaterEqual: Incompatible dimensions");
  typename T1::const_iterator b1=v1.begin(), e1=v1.end();
  typename T2::const_iterator b2=v2.begin();
