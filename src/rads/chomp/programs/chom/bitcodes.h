...
//-----------------------------------------------------------------------------
/*! \file bitcodes.h
    \brief Classes for manipulation of bitcodes for \f$d\f$-cells and vertices.

    This file contains declarations for bitcode classes used to store the 
    geometric location of \f$d\f$-cells and vertices. It is a base class for
    blocks and vertices.
